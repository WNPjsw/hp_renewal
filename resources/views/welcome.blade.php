...
<head>
    ...
    <script type = "text/javascript">
        ...
        function Make_Display_None(){
            $(".smartfactory").css("display","none");
            $(".access").css("display","none");
            $(".schedule").css("display","none");

            $(".business_line_01").css("display","none");
            $(".business_line_02").css("display","none");
            $(".business_line_03").css("display","none");
        }

        function Make_None_Color(){
            $('label[for*="business_btn"]').css("color","");
        }
        ...
        $(function(){                   
            ...
            $("#business_btn1").click(function(){
                Make_Display_None();
            //    Make_None_Color();
                $(".smartfactory").css("display","block");
                $(".business_line_01").css("display","block");
            //    $('label[for="business_btn1"]').css("color","#056cf2");
            });

            $("#business_btn2").click(function(){
                Make_Display_None();
            //    Make_None_Color();
                $(".access").css("display","block");
                $(".business_line_02").css("display","block");
            //    $('label[for="business_btn2"]').css("color","#056cf2");
            });

            $("#business_btn3").click(function(){
                Make_Display_None();
            //   Make_None_Color();
                $(".schedule").css("display","block");
                $(".business_line_03").css("display","block");
            //  $('label[for="business_btn3"]').css("color","#056cf2");
            });

            /*$('input[name="business_btn"]').each(function() {
                var checked = $(this).prop('checked'); 
                var $label = $(this).parent();
        
                if(checked)
                    $label.css('color', "#056cf2");
            });*/
    ...
    <section class="wrap">
       ...
       <!--메인 배너 슬라이드-->
        ...
        <div id="business">
            ...
            <div class="b_title">
                ...
                <div class="business_txt_02">
                    <label for="business_btn1"> <input type="radio" name="business_btn" id="business_btn1" checked>Smart Factory</label><li><span class = "business_line_01" style = "display : none"></span></li>
                    <label for="business_btn2"><input type="radio" name="business_btn" id="business_btn2">출입 관리</label><li><span class = "business_line_02" style = "display : none"></span></li>
                    <label for="business_btn3"> <input type="radio" name="business_btn" id="business_btn3">출장 관리</label><li><span class = "business_line_03" style = "display : none"></span></li>
        ...
        <div id="portfolio_box">
            ...
            <div class="portfolio_image swiper mySwiper2">
                <p></p>
                <ul class = "swiper-wrapper">
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_01.jpg" /><figcaption>CP- MS 디자인 개편<br />
                        <span>씨에이프로텍(주)</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_02.jpg" /><figcaption>스마트 출입관리 시스템<br />
                        <span>(주)삼경엠에스</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_03.jpg" /><figcaption>운송정보 시스템<br />
                        <span>고려아연(주)</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_04.jpg" /><figcaption>오존 농도 측정 시스템<br />
                        <span>(주)랩시스텍</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_05.jpg" /><figcaption>히트쿠키 (도매몰)<br />
                        <span>(주)랩시스텍</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_06.jpg" /><figcaption>MES시스템<br />
                        <span>한국섬유개발원</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_07.jpg" /><figcaption>홈페이지 유지보수<br />
                        <span>(주)일성하이스코</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_08.jpg" /><figcaption>스마트팩토리<br />
                        <span>(주)선재하이테크, 센텀전자(주)</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_09.jpg" /><figcaption>생산 및 외주관리 시스템<br />
                        <span>동일유리(주)</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_10.jpg" /><figcaption>재고/부스관리 시스템<br />
                        <span>(주)퍼플아이앤씨</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_11.jpg" /><figcaption>데이터분석 시스템<br />
                        <span>(주)아무르</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_12.jpg" /><figcaption>전자결재 시스템<br />
                        <span>경북보건대학교</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_13.jpg" /><figcaption>GBT 심리 검사 시스템<br />
                        <span>GBT 뇌기반학습튜터링센터</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_14.jpg" /><figcaption>UYeG<br />
                        <span>(주)아이티공간</span></figcaption></figure></a></li>
                    <li class = "swiper-slide"><a href="#"><figure><img src="images/portfolio_15.jpg" /><figcaption>영업관리 시스템<br />
